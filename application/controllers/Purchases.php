...
class Purchases extends CI_Controller
{
    ...
    public function add_purchases($id){
        ...
        $data['ma5zon'] = $this->Storage->select_id();//$this->Purchase->get_by_method(0);
        $data['asnaf'] = $this->Purchase->select_sanf2();//$this->Purchase->select_sanf('sanf_type!=',3);
        ...
        elseif($this->input->post('save') && $id != 0){
        ...
        elseif($this->input->post('load') || $this->input->post('method') || $this->input->post('sanf_id')){
