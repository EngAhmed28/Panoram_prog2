...
<div class="container">
	<div class="row">
		<div class="col-sm-4 ">
		<img src="<?php echo base_url()?>asisst/web_asset/img/join.png">
		<img src="<?php echo base_url()?>asisst/web_asset/img/join2.png" width="100%">	
				...
				<div class="panel panel-primary">
			                ...
			                <div class="panel-body">
			                    ...
			                    <div class="form-group">
			                        ...
			                        <input class="form-control" type="number" name="phone" placeholder="مثال:+2 22222" required />
			                    </div>
			                    <div class="form-group">
			        ...
			        <div class="text-center">
			            <input type="submit" class="btn btn-lg btn-info btn-responsive " name="send" value="إرسل" />
			        </div>
					</fieldset>
