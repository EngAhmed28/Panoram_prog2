...
?>
                 ...
                 <div class="form-group">
                        ...
                        <div class="form-group">
							...
							<label for="exampleInputEmail1"> نوع الموضوع </label>
                            <br />
                            <input type="radio" name="type" value="1" required /> شكوى 
                             &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
                            
                            <input type="radio" name="type" value="2" required /> مقترح 
						...
						<div class="form-group">
							...
							<textarea class="form-control" placeholder="التفاصيل" name="details" rows="9" required></textarea>
