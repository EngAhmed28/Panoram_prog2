                ...
                <div class="panel panel-default <?php echo $cc; ?>">
                    ...
                    <form name="<?php echo $record->id ?>" method="post">
                        ...
                        <div class="col-xs-12" style="margin-bottom: 10px;">
                          ...
                          <!--
                          <div class="col-xs-2">
                          <label for="inputUser" class="col-lg-1 control-label">الخصم:</label>
                          </div>
                          <div class="col-xs-2">
                              <input type="text" class="form-control" step="any" value="0" id="total_des<?php echo $record->id ?>" name="total_des<?php echo $record->id ?>" readonly/>
...
class="<?php echo $record->id ?>" /></td> 
     ...
     class="form-control input-sm"  value="0" rel="3" step="any" readonly="readonly" />
