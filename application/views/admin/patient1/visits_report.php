        ...
        for($x = 0 ; $x < count($records) ; $x++){ 
            ...
            <tr>
                ...
                for($z = 0 ; $z < count($records[key($records)][key($records[key($records)])][key($records[key($records)][key($records[key($records)])])]) ; $z++)
                {
                    ...
                    if($records[key($records)][key($records[key($records)])][key($records[key($records)][key($records[key($records)])])][$z]->status == 1 && $z > 0)
                    {
                        if($z == 1){
                                ...
                                $payment += $records[key($records)][key($records[key($records)])][key($records[key($records)][key($records[key($records)])])][0]->paid;
                        }
