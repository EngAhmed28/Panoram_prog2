...
<div class="well bs-component" data-sr="wait 0s, then enter left and hustle 100%">
    ...
    <?php if(isset($result)):?>
        ...
        <?php echo form_open_multipart('dashboard/update_dep/'.$result['id'],array('class'=>"form-horizontal",'role'=>"form" ))?>
        ...
        <fieldset>
            ...
            <div class="form-group" data-sr="wait 0.6s, then enter bottom and hustle 100%">
                ...
                <div class="col-lg-10 input-grup">
                    ...
                    <input type="text" id="name"  value="<?php echo $result['name']; ?>" name="name" class="form-control text-right" placeholder="   إسم القسم" required>
    ...
    <?php else: ?>
        ...
        <?php echo form_open_multipart('dashboard/add_dep',array('class'=>"form-horizontal",'role'=>"form" ))?>
        <fieldset>
        ...
        ?>
            <tr>
                ...
                <td data-title="التحكم" class="text-center">
                    ...
                    <a href="<?php echo base_url().'dashboard/update_dep/'.$record->id?>" class="btn btn-warning btn-xs col-lg-5"><i class="fa fa-pencil"></i> تعديل</a>

                    <a  href="<?php echo base_url().'dashboard/delete_dep/'.$record->id?>" onclick="return confirm('هل انت متأكد من عملية الحذف ؟');" class="btn btn-danger btn-xs   col-lg-5"><i class="fa fa-trash"></i> حذف</a>

                </td>
                
                <td data-title="" class="text-center">

                    <a href="<?php echo base_url().'dashboard/suspend_dep/'.$record->id.'/'.$class?>" class="btn btn-<?php echo $class ?> btn-xs col-lg-6"><?php echo $title ?> </a>
