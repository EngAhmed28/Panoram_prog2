        ...
        <div class="row">
            <div class="col-md-4">
                <div class="layout">
                    <div class="form-group ">
                        <label>المخزن</label>
                        <select name="ma5zon" id="ma5zon" class="required form-control" <?php echo $dis ?> required>
            ...
            <div class="col-md-4">
                <div class="layout">
                    <div class="form-group">
                        ...
                        <select name="sanf" id="sanf" onchange="get_unit($('#sanf').val(),<?php echo $id ?>);" class="selectpicker form-control" data-live-search="true" required>
                            <option value="">قم بإختيار الصنف</option>
                            <?php
                            foreach($asnaf as $sanf){
                                echo '<option value="'.$sanf->id.'" disabled>'.$sanf->p_name.'</option>';
                                if(isset($sanf->sub) && $sanf->sub != null)
                                    foreach($sanf->sub as $subs)
                                        echo '<option value="'.$subs->id.'">'.$subs->p_name.'</option>';
                            }
                            ?>
                        </select>
                    </div>
