...
<div class="col-md-3">
    ...
    <div class="col-md-3" id="contract_idup">
        <div class="form-group">
            <label class="control-label">قرار التكليف </label>
              <div class="row">
            <div class="col-lg-4">
            <input type="text" name="" class="form-control" value="<?php echo $result[0]->img ?>" style=""  readonly="readonly"/>
            </div>
                  <div class="col-lg-8">
    ...
    <? }?>
            <div class="col-md-3" id="contract_idup" style="display: none">
                <div class="form-group">
                    <label class="control-label">قرار التكليف </label>
                    <div class="row">
                        <div class="col-lg-8">
        ...
        <?php $count=1; foreach($records as $record ):?>
            <tr>
                ...
                <td data-title="التحكم" class="text-right">
                    <a href="<?php echo base_url().'Administrative_affairs/edit_employee/'.$record->id?>" class="btn btn-warning btn-xs"><i class="fa fa-pencil"></i> تعديل</a>
                    <a  href="<?php  echo base_url().'Administrative_affairs/delete_employee/'.$record->id?>" onclick="return confirm('هل انت متأكد من عملية الحذف ؟');" class="btn btn-danger btn-xs "><i class="fa fa-trash"></i> حذف</a>
                </td>
            </tr>
        <?php endforeach ;?>
        </tbody>
